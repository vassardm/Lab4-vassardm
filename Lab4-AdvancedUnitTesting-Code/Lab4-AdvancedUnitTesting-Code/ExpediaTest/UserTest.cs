...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            DateTime StartDateLocal = new DateTime(2009, 11, 1);
		    DateTime EndDateLocal = new DateTime(2009, 11, 30);
            DateTime remainingStartDateLocal = new DateTime(2009, 12, 1);
            DateTime remainingEndDateLocal = new DateTime(2009, 12, 30);
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(StartDateLocal, EndDateLocal, 100);
            var remainingFlight = new Flight(remainingStartDateLocal, remainingEndDateLocal, 100);
